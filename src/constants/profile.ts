...
const NakshtraRasi = [
    ...
    {
        value: 'Kanya - Chitra (Chithirai)',
        label: 'Kanya - Chitra (Chithirai)',
    },
    {
        value: 'Kanya - Hastha (Hastham)',
        label: 'Kanya - Hastha (Hastham)',
    },
    {
    ...
    {
        value: 'Kataka - Pushyami (Pusam)',
        label: 'Kataka - Pushyami (Pusam)',
    },
    {
    ...
    {
        value: 'Thula - Chitra (Chithirai)',
        label: 'Thula - Chitra (Chithirai)',
    },
    { value: 'Thula - Svati (Swathi)', label: 'Thula - Svati (Swathi)' },
    {
        value: 'Thula - Vishaka (Visakam)',
        label: 'Thula - Vishaka (Visakam)',
    },
    {
