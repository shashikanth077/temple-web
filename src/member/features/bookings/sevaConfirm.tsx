...
import { selecLocalSevaData } from './bookingSelector';
        ...
        if (stripe) {
            ...
            if (!error) {
                ...
                if (payload.error) {
                    ...
                    requestPayload.sevaType = BookDetails?.type;
                    requestPayload.devoteeId = loggedInUser?.devoteeId;
                    requestPayload.orderType = 'seva';
                    ...
                    dispatch(myBookingsActions.confirmPayment(requestPayload)); //add booking history
...
export default SevaConfirmPage;
