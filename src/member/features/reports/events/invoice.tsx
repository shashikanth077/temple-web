...
import { selectContactDetails } from 'contents/content/contactSelectors';
                    ...
                    <main>
                        <div className="row contacts">
                            ...
                            <div className="col invoice-details">
                                <h3 className="invoice-id">INVOICE # {invoiceDetails?.eventBookId}</h3>
                        ...
                        <table border={0} cellSpacing="0" cellPadding="0">
                            <thead>
                                <tr>
                                    ...
                                    <th className="text-center">Organizer</th>
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-center donationType">{invoiceDetails?.eventName}</td>
                                        <td className="text-center donationType">{invoiceDetails?.venue}</td>
                                        <td className="text-center donationType">{moment(invoiceDetails?.startDate).format('DD-MM-YYYY')}</td>
                                        <td className="text-center donationType">{moment(invoiceDetails?.endDate).format('DD-MM-YYYY')}</td>
                                        <td className="text-center qty">{invoiceDetails?.organizer}</td>
