    ...
    const onSubmit = handleSubmit(async (data: any) => {
        ...
        if (stripe) {
            ...
            const paymentIntentDetails = {
                ...
                bookingDetails:cartItems?.items,
            ...
            if (!error) {
                ...
                if (payload.error) {
                    ...
                    requestPayload.orderType = 'shop-orders';
                    ...
                    let CartPayload:any = {};
                    CartPayload.userid =  loggedInUser?.id;
                    CartPayload.productId = 0;
                    CartPayload.type = 'delete-all';

                    dispatch(cartActions.AddShopDetails(requestPayload)); //add booking history
                    dispatch(cartActions.deleteFromCart(CartPayload));   //delete cart after purchase
