...
export default function ServiceBookings() {
    ...
    useEffect(() => {
        dispatch(myBookingsActions.getOrders({ userId: loggedInUser?.id,type:"events"}));
    }, [dispatch]);
        ...
        <div>
            ...
            <div className="">
                ...
                <DataTable
                    ...
                    header={header}
                >
                    <Column field="eventBookId" header="Booking id" />
                    <Column field="eventName" header="Event name" />
                    <Column field="amount" header="Booking price" />
                    <Column field="venue" header="Venue" />
                    <Column field="amount" header="amount" />
                    <Column field="startDate" sortable header="start Date" body={(rowData) => formatDate(rowData.startDate)} />
                    <Column field="endDate" sortable header="end Date" body={(rowData) => formatDate(rowData.endDate)} />
                    <Column
                        field="transStatus"
                        sortable
                        style={{ width: "2rem" }}
