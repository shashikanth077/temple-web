        ...
        <div className="container temple-receipt-header">
            <div className="col-md-12">
                <div className="text-center">
                    <img src={`${window.location.origin}/assets/images/logo/${templeDetails?.TempleLogo}`} width={30} alt="logo" /><p className="temple-name pt-2">{templeDetails?.TempleName}</p>
                    ...
                    <div className="temple-contact-info">
                        ...
                        <p>{templeDetails?.Emailaddress}</p>
                    </div>
                </div>
            </div>
        </div>
