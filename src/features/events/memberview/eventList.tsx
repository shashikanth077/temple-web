...
import EventTopBar from '../pages/eventTopbar';
...
function Events() {
    ...
    return (
        <section className="area-padding">
            ...
            <EventContent member onchangclick={handlePageClick} events={eventsList} currentEventData={currentData} pageCount={pageCount} />
        </section>
    );
}
