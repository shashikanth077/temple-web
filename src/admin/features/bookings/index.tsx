...
import { selectServices } from './bookingSelector';
        ...
        <div>
            ...
            <div className="">
                ...
                <DataTable
                    ...
                    header={header}
                >
                    <Column field="bookingType" header="God name" sortable style={{ minWidth: '10rem' }} />
                    <Column field="BookingName" header="Service name" sortable style={{ minWidth: '8rem' }} />
                    <Column field="amount" header="Service type" sortable style={{ minWidth: '8rem' }} />
