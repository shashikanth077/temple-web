...
export function getBookingById(payload:any) {
    const baseUrl = `${config.API_BASE_URL}/api/seva/booking/${payload._id}`;
    const response = APICore.get(baseUrl, {});
    return response;
}

export function getBookingsDetails(payload:any) {
    const baseUrl = `${config.API_BASE_URL}/api/seva/booking-details`;
    const response = APICore.create(baseUrl, {});
    return response;
}

export function addBookings(payload:any) {
    const baseUrl = `${config.API_BASE_URL}/api/seva/booking`;
...
export function editBookings(payload:any) {
    const baseUrl = `${config.API_BASE_URL}/api/seva/booking/${payload.get('_id')}`;
